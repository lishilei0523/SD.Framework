...
namespace SD.Infrastructure.Maui.Caliburn.Extensions
{
    ...
    public static class MessageBox
    {
        ...
        /// 警告消息
        /// </summary>
        public static async Task Alert(string message, string title = null, CancellationToken? cancelToken = default)
        {
        ...
        /// </summary>
        /// <remarks>带振动</remarks>
        public static async Task AlertVibrantly(string message, string title = null, int vibratedDuration = 500, CancellationToken? cancelToken = default)
        {
            Vibration.Vibrate(vibratedDuration);
            await UserDialogs.Instance.AlertAsync(message, title, "确定", cancelToken);
        }
        ...
        /// 确认消息
        /// </summary>
        public static async Task<bool> Confirm(string message, string title = null, CancellationToken? cancelToken = default)
        {
        ...
        /// 确认消息
        /// </summary>
        public static async Task<bool> ConfirmVibrantly(string message, string title = null, int vibratedDuration = 500, CancellationToken? cancelToken = default)
        {
            Vibration.Vibrate(vibratedDuration);
            return await UserDialogs.Instance.ConfirmAsync(message, title, "确定", "取消", cancelToken);
        }
