...
namespace SD.Infrastructure.AspNetCore.Toolkits
{
    ...
    internal static class ValidCodeGenerator
    {
        ...
        public static string GenerateCode(int length)
        {
            ...
            if (length > ValidCodeGenerator.MaxLength)
            {
                length = ValidCodeGenerator.MaxLength;
            }
            if (length < ValidCodeGenerator.MinLength)
            {
                length = ValidCodeGenerator.MinLength;
            }
        ...
        public static byte[] GenerateStream(string validCode)
        {
            ...
            {
                //绘制验证码
                MemoryStream stream = ValidCodeGenerator.DrawValidCode(validCode, graphic, image);
