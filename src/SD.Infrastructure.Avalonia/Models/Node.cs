...
namespace SD.Infrastructure.Avalonia.Models
{
    ...
    /// 树节点
    /// </summary>
    public class Node : StyledElement
    {
        #region # 构造器
        ...
        {
            //注册依赖属性
            IsSelectedProperty = AvaloniaProperty.Register<Node, bool?>(nameof(IsSelected), false);
            IsCheckedProperty = AvaloniaProperty.Register<Node, bool?>(nameof(IsChecked), false);
            IsCheckedProperty.Changed.AddClassHandler<Node>(OnIsCheckedChanged);
        }
        #endregion
        ...
        {
            get => base.GetValue(IsSelectedProperty);
        ...
        /// 是否勾选依赖属性
        /// </summary>
        public static StyledProperty<bool?> IsCheckedProperty;
        ...
        {
            get => base.GetValue(IsCheckedProperty);
        ...
        #region 是否选中改变回调方法 —— static void OnIsCheckedChanged(Node node...
        /// <summary>
        /// 是否选中改变回调方法
        /// </summary>
        private static void OnIsCheckedChanged(Node node, AvaloniaPropertyChangedEventArgs eventArgs)
        {
