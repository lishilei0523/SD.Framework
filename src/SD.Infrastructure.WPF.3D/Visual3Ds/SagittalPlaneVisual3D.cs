...
namespace SD.Infrastructure.WPF.ThreeDims.Visual3Ds
{
    ...
    /// </summary>
    public class SagittalPlaneVisual3D : MeshElement3D
    {
        /// <summary>
        /// Identifies the <see cref="DivLength"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty DivLengthProperty = DependencyProperty.Register(nameof(DivLength), typeof(int), typeof(SagittalPlaneVisual3D), new UIPropertyMetadata(10, GeometryChanged, CoerceDivValue));

        /// <summary>
        /// Identifies the <see cref="DivWidth"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty DivWidthProperty = DependencyProperty.Register(nameof(DivWidth), typeof(int), typeof(SagittalPlaneVisual3D), new UIPropertyMetadata(10, GeometryChanged, CoerceDivValue));

        /// <summary>
        /// Identifies the <see cref="LengthDirection"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty LengthDirectionProperty = DependencyProperty.Register(nameof(LengthDirection), typeof(Vector3), typeof(SagittalPlaneVisual3D), new PropertyMetadata(new Vector3(0, 1, 0), GeometryChanged));

        /// <summary>
        /// Identifies the <see cref="Length"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty LengthProperty = DependencyProperty.Register(nameof(Length), typeof(float), typeof(SagittalPlaneVisual3D), new PropertyMetadata(10.0f, GeometryChanged));

        /// <summary>
        /// Identifies the <see cref="Normal"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty NormalProperty = DependencyProperty.Register(nameof(Normal), typeof(Vector3), typeof(SagittalPlaneVisual3D), new PropertyMetadata(new Vector3(1, 0, 0), GeometryChanged));

        /// <summary>
        /// Identifies the <see cref="Origin"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty OriginProperty = DependencyProperty.Register(nameof(Origin), typeof(Vector3), typeof(SagittalPlaneVisual3D), new PropertyMetadata(new Vector3(0, 0, 0), GeometryChanged));

        /// <summary>
        /// Identifies the <see cref="Width"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty WidthProperty = DependencyProperty.Register(nameof(Width), typeof(float), typeof(SagittalPlaneVisual3D), new PropertyMetadata(10.0f, GeometryChanged));
